...
for snr_level in range(5,55,5):
    ...
    for i in range(1,TotalNoOfFiles):
        ...
        '''
        ScoreList.append(float(logProb[i-1][3])) # if bestScoreInd = 0
        #print("LogProb["+str(i)+"]: "+ logProb[i][3])
        ScoreList.append(float(logProb[i-1][0]))    # if bestScoreInd = 1
        ScoreList.append(float(logProb[i-1][1]))    # if bestScoreInd = 2
        ScoreList.append(float(logProb[i-1][2]))    # if bestScoreInd = 3
